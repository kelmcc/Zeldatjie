...
namespace Framework
{
    ...
    public static class TransformExtensions
    {
        ...
        public static Transform[] GetAllChildren(this Transform transform, bool includeRoot = false)
        {
            if (includeRoot)
            {
            ...
            return transform.gameObject.GetComponentsInChildrenOnly<Transform>();
        }

        public static Transform[] GetChildren(this Transform transform, bool includeRoot = false)
        {
            if (includeRoot)
            {
