...
namespace Framework
{
    ...
    public static class DebugUtils
    {
        ...
        static void DrawGizmo(Action drawAction)
        {
            ...
            else
            {
                ...
                if (_gizmoDrawer == null)
                {
                    ...
                    UnityEditor.EditorApplication.playModeStateChanged += stateChange => _drawActions.Clear();
                    UnityEditor.EditorApplication.pauseStateChanged += stateChange => _drawActions.Clear();
                }
        ...
        {
            Camera camera = UnityEditor.SceneView.currentDrawingSceneView.camera;
