...
namespace Framework
{
    ...
    public static class MathUtils
    {
        ...
        */
        ...
        {
            return CalculateProjectileArc(launchPosition, launchVelocity, Time.fixedDeltaTime, maxTime, Physics.gravity);
        }

        public static Vector3[] CalculateProjectileArc(Vector3 launchPosition, Vector3 launchVelocity, float timeStep, float maxTime)
        {
            return CalculateProjectileArc(launchPosition, launchVelocity, timeStep, maxTime, Physics.gravity);
        }

        public static Vector3[] CalculateProjectileArc(Vector3 launchPosition, Vector3 launchVelocity, float timeStep, float maxTime, Vector3 gravity)
        {
        ...
        {
            return CalculateProjectileArc(launchPosition, targetPosition, launchVelocity, Time.fixedDeltaTime, Physics.gravity);
        }
        ...
        {
            return CalculateProjectileArc(launchPosition, targetPosition, launchVelocity, timeStep, Physics.gravity);
        }

        public static Vector3[] CalculateProjectileArc(Vector3 launchPosition, Vector3 targetPosition, Vector3 launchVelocity, float timeStep, Vector3 gravity)
        {
            ...
            do
            {
                Vector3 point = launchPosition + (launchVelocity * t) + (0.5f * gravity * t * t);
